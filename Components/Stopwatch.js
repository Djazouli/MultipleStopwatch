...
export class Stopwatch extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            timer: setInterval(() => {
                this.setState({
                    timeString:  formatMilliseconds((new Date()).getTime() - this.state.timeStarted.getTime() + this.state.timeElapsed)
                })
            }, 10),
    ...
    pause() {
        ...
        this.setState({
            isPaused: true,
            touched: false,
            timeElapsed: (new Date()).getTime() - this.state.timeStarted.getTime() + this.state.timeElapsed,
        })
    }
